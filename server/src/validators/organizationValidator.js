...
const organizationSchema = Joi.object({
  name: Joi.string()
    ...
    .messages({
      ...
      'string.min':
        'Название организации должно содержать минимум {#limit} символа',
      'string.max':
        'Название организации должно содержать максимум {#limit} символов',
...
const organizationUpdateSchema = organizationSchema.keys({
  name: Joi.string()
    ...
    .messages({
      ...
      'string.max':
        'Название отдела должно содержать максимум {#limit} символов',
    }),
});
